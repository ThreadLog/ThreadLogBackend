...
import { cleanUpOldArchivedJobsService, archiveExpiredJobsService, } from "../services/job.service.js";
    ...
    cron.schedule("0 0 * * *", async () => {
        ...
        try {
            ...
            if (deletedCount.count > 0) {
                ...
                console.log(`[Cron] Sucessfully deleted ${deletedCount.count} old archived jobs.`);
            }
            else {
