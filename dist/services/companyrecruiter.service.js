...
export const GetAllCompanyRecruitersService = async (queryFilters, pagination) => {
    const whereClause = {};
    ...
    if (queryFilters?.city) {
        whereClause.city = {
            equals: queryFilters.city,
            mode: "insensitive",
        };
    }
    if (queryFilters?.country) {
        whereClause.country = {
            equals: queryFilters.country,
            mode: "insensitive",
        };
    }
    if (queryFilters?.industry) {
        whereClause.industry = {
            equals: queryFilters.industry,
            mode: "insensitive",
        };
    }
