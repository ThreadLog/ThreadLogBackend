import { registerJobSeekerService, logInJobSeekerService, registerAdminService, logInAdminService, logInAdminByCodeService, getAdminAccessCodeService, } from "../services/auth.service.js";
...
export const LogInAdminByCode = async (req, res, next) => {
    try {
        const data = req.body;
...
export const DownloadAdminAccessCode = async (req, res, next) => {
    try {
        ...
        res.setHeader("Content-Disposition", `attachment; filename="admin-access-code-${admin.id}.txt"`);
